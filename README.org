...
Racket wants you to use it for things. It is kind and pretty well thought out.
The standard library is ginormous and pretty parts-complete, and for those few
...
especially clear way to document an /application/. It just doesn't /click/.
